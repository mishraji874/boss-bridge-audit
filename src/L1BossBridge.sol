...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    mapping(address account => bool isSigner) public signers; // users who can send token from l1 to l2
    ...
    // Bob: depositTokensToL2(from: Alice, l2Recipient: Bob, all his money)
